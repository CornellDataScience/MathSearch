...
if __name__ == "__main__":
  ...
  for _, row in db.iterrows():
    similarity_scores.append(get_similarity("ranking/dataset/"+target, "ranking/dataset/exp/crops/equation/"+row["image_name"]))
  ...
  top5.to_csv("ranking/top5.txt", index=False, header=False)
